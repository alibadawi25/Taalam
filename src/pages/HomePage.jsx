    ...
    <main className="home-page">
      ...
      <div className="scroll-content">
        ...
        <section className="paths-section" id="paths">
          <div className="section-container">
            <h2 className="section-title">مسارات التعلم</h2>
            <p className="section-subtitle">
              اختر المسار الذي يناسبك وابدأ رحلتك
            </p>

            <div className="paths-grid">
              <div className="path-card">
                <div className="path-header">
                  <span className="path-badge">للمبتدئين</span>
                </div>
                <h3 className="path-title">أساسيات العقيدة</h3>
                <p className="path-desc">
                  تعرف على أركان الإيمان والإسلام بطريقة سهلة ومبسطة
                </p>
                ...
                <button className="path-btn">ابدأ المسار</button>
              </div>

              <div className="path-card featured">
                <div className="path-header">
                  <span className="path-badge">الأكثر شعبية</span>
                </div>
                <h3 className="path-title">تعلم الصلاة</h3>
                <p className="path-desc">
                  من الوضوء إلى إتقان الصلاة بخشوع وتدبر
                </p>
                <div className="path-meta">
                  <span>18 درس</span>
                  <span>•</span>
              ...
              <div className="path-card">
                <div className="path-header">
                  <span className="path-badge">متوسط</span>
                </div>
                <h3 className="path-title">أحكام الصيام</h3>
                <p className="path-desc">
                  كل ما تحتاج معرفته عن صيام رمضان والنوافل
                </p>
                <div className="path-meta">
                  <span>10 دروس</span>
                  <span>•</span>
